...
class ActionProvider {
  ...
  handleHumanHelp(shows, setShow, id) {
    const message = this.createChatBotMessage(
      "Well, bitcoin prices are volatile. I'm glad you made gains in it but cryptocurrencies have been seeing a dip in their value since the rise of the geopolitical tensions in the Middle East"
    );
    const message2 = this.createChatBotMessage(
